...
output_dir <- "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/Noise2AOI/processed/raster_pro_KRS"
...
df <- df_final[, !(names(df_final) %in% "253_J_2017")]
View(df)
write_csv(df, "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/Noise2AOI/processed/DLR_Road_Traffic_Noise_J_2017.csv")
