...
paths <- list(
  "2018" = "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/DLR_S_VELD_NO2_PM2_5/S5P_TROPOMI_NO2SURF/processed/NO2SURF_AnnualMedian_2018.tif",
  "2019" = "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/DLR_S_VELD_NO2_PM2_5/S5P_TROPOMI_NO2SURF/processed/NO2SURF_AnnualMedian_2019.tif",
  "2020" = "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/DLR_S_VELD_NO2_PM2_5/S5P_TROPOMI_NO2SURF/processed/NO2SURF_AnnualMedian_2020.tif"
...
output_dir <- "C:/Users/agnes/Documents/EAGLE/Innovation_Lab/Daten/DLR_S_VELD_NO2_PM2_5/S5P_TROPOMI_NO2SURF/processed/"
...
for (year in names(paths)) {
  ...
  colnames(m) <- paste0("NO2SURF_Median_J_", year, "_mean")
  m$ARS <- landkreise$ARS

  # Median
  med <- terra::extract(r, landkreise, fun = median, na.rm = TRUE, ID = FALSE)
  colnames(med) <- paste0("NO2SURF_Median_J_", year, "_median")
...
View(stats_all)
# Export
write_csv(stats_all, file.path(output_dir, "DLR_NO2SURF_Median_J_2018_2020.csv"))
